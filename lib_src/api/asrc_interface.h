 ...
 */
void asrc_init_buffer(asrc_interface_t *asrc_data_buffer,
                      int channel_count,
                      int max_fifo_depth);
 ...
 *                              was input.
 */
void asrc_add_quad_input(asrc_interface_t *asrc_data_buffer,
                         int32_t *samples,
                         int32_t timestamp);
 ...
 *
 * @param   asrc_data_buffer    ASRC structure to pull a sample out off.
 *
 ...
 */
void asrc_get_single_output(asrc_interface_t *asrc_data_buffer,
                            int32_t *samples,
                            int32_t timestamp);
 ...
 * on the stack
 */
typedef struct asrc_interface_t {
    ...
    int64_t   last_phase_error;               /* Last phase error seen, used for proportional error */
