...
#define _INT_ARITHMETIC_H_
	...
	// To avoid C type definitions when including this file from assembler
		...
		// ==================================================================== //
		// Function:		LATS27												//
		// Description:		Saturate 64i to 2^60-1, -2^60						//
		// (Result from 4.28 x 1.31 multiplication								//
		// ==================================================================== //
		#define		MAX_VAL64_28		(__int64)0x0FFFFFFFFFFFFFFF
		#define		MIN_VAL64_28		(__int64)0xF000000000000000
		void	LSAT28(__int64 *plx);

		// ==================================================================== //
		// Function:		EXT27												//
		// Description:		Extracts bits [59-28] into 32i						//
		// ==================================================================== //
		void	EXT28(int *pr, __int64 lx);
